...
This project is designed to demonstrate my SQL skills and also the  techniques typically used by data analysts to explore, clean, and analyze retail sales data. The project involves setting up a retail sales database, importing external tables, performing exploratory data analysis (EDA), and answering specific business questions through SQL queries. This project is ideal for those who are starting their journey in data analysis and want to build a solid foundation in SQL.
...
- **Customer Demographics**: The dataset features customers from a range of age groups, with sales spread across categories like Clothing and Beauty.
- **High-Value Transactions**: A number of transactions exceeded $1000, highlighting premium purchases.
- **Sales Trends**: A month-by-month analysis reveals fluctuations in sales, helping to pinpoint peak seasons.
- **Customer Insights**: The analysis highlights the highest-spending customers and the most popular product categories.

## Reports

- **Sales Overview**: A comprehensive report covering total sales, customer demographics, and performance by category.
- **Trend Analysis**: Insights into monthly sales patterns and shifts over time.
- **Customer Insights**: Reports detailing the top customers and the number of unique customers per product category.
